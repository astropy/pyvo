...
class SAMPIntegratedClient:
    ...
    that merges the :class:`~pyvo.astropy_samp.SAMPClient` and
    :class:`~pyvo.astropy_samp.SAMPHubProxy` functionalities in a
    simplified API.
    ...
    def connect(self, hub=None, hub_params=None, pool_size=20):
        ...
        Parameters
        ----------
        hub : `~pyvo.astropy_samp.SAMPHubServer`, optional
    ...
    def enotify(self, recipient_id, mtype, **params):
        """
        Easy to use version of :meth:`~pyvo.astropy_samp.integrated_client.SAMPIntegratedClient.notify`.
    ...
    def enotify_all(self, mtype, **params):
        """
        Easy to use version of :meth:`~pyvo.astropy_samp.integrated_client.SAMPIntegratedClient.notify_all`.
    ...
    def ecall(self, recipient_id, msg_tag, mtype, **params):
        """
        Easy to use version of :meth:`~pyvo.astropy_samp.integrated_client.SAMPIntegratedClient.call`.
    ...
    def ecall_all(self, msg_tag, mtype, **params):
        """
        Easy to use version of :meth:`~pyvo.astropy_samp.integrated_client.SAMPIntegratedClient.call_all`.
    ...
    def ecall_and_wait(self, recipient_id, mtype, timeout, **params):
        """
        Easy to use version of :meth:`~pyvo.astropy_samp.integrated_client.SAMPIntegratedClient.call_and_wait`.
    ...
    def ereply(self, msg_id, status, result=None, error=None):
        """
        Easy to use version of :meth:`~pyvo.astropy_samp.integrated_client.SAMPIntegratedClient.reply`.
        ...
        Examples
        --------
        >>> from pyvo.astropy_samp import SAMPIntegratedClient, SAMP_STATUS_ERROR
        >>> cli = SAMPIntegratedClient()
        >>> ...
