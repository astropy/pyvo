...
class SAMPClient:
    ...
    Parameters
    ----------
    hub : :class:`~pyvo.astropy_samp.SAMPHubProxy`
        An instance of :class:`~pyvo.astropy_samp.SAMPHubProxy` to be
    ...
    def receive_notification(self, private_key, sender_id, message):
        ...
        :meth:`~pyvo.astropy_samp.client.SAMPClient.bind_receive_notification`
        ...
        :class:`~pyvo.astropy_samp.SAMPClient` class this method should be
        overwritten.
    ...
    def receive_call(self, private_key, sender_id, msg_id, message):
        ...
        This method is automatically handled when the
        :meth:`~pyvo.astropy_samp.client.SAMPClient.bind_receive_call` method is
    ...
    def receive_response(self, private_key, responder_id, msg_tag, response):
        ...
        This method is automatically handled when the
        :meth:`~pyvo.astropy_samp.client.SAMPClient.bind_receive_response` method
    ...
    def bind_receive_message(self, mtype, function, declare=True,
        ...
        declare : bool, optional
            ...
            :meth:`~pyvo.astropy_samp.client.SAMPClient.declare_subscriptions`).
    ...
    def declare_subscriptions(self, subscriptions=None):
        ...
        :meth:`~pyvo.astropy_samp.client.SAMPClient.bind_receive_notification`
        and :meth:`~pyvo.astropy_samp.client.SAMPClient.bind_receive_call`.

        An optional ``subscriptions`` map can be added to the final map passed
        to the :meth:`~pyvo.astropy_samp.hub_proxy.SAMPHubProxy.declare_subscriptions`
        method.
        ...
        subscriptions : dict, optional
            ...
            :meth:`~pyvo.astropy_samp.hub_proxy.SAMPHubProxy.declare_subscriptions`
            method.
        """
        if self._callable:
